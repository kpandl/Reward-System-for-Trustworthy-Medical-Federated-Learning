...
for i in range(num_jobs):
    ...
    with open("job_rewardsystems_labelflip_exp1_5p_4_"+str(seeds_start+i*4)+".sh", "w+") as file:
        file.writelines(line_list)

    time.sleep(0.8)
    os.system("sbatch -p single --ntasks=1 --time=24:00:00 --mem=100gb " + "job_rewardsystems_labelflip_exp1_5p_4_"+str(seeds_start+i*4)+".sh")